...
namespace SeleniumWrapper
{
    public partial interface IWebDriver
    {
		...
		[Description(" Captures the Network Traffic that is passing through Selenium Server Type of traffic to captureThe traffic passing through the Selenium Server.")]
		...
		[Description(" Sets the extension Javascript for the session The extention JavaScript to use.")]
