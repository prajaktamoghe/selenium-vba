...
namespace vbsc {
    ...
    class MultiScriptRunner {
        ...
        private List<ScriptResult> _list_results = new List<ScriptResult>();
        ...
        public List<ScriptResult> Run(string[] lst_scripts_paths, string[] lst_arguments, string[] lst_parameters, string procedure_pattern, bool debug) {
