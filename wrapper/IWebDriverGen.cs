...
namespace SeleniumWrapper
{
    public partial interface IWebDriver
    {
		...
		[Description("Captures a PNG screenshot to the specified file. the absolute path to the file to be written, e.g. \"c:\\blah\\screenshot.png\"")]
		...
		void refresh();
		void refreshAndWait();
		[Description("Simulates the user clicking the \"close\" button in the titlebar of a popup window or tab. ")]
		void close();
